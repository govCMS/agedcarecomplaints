...
//Main Menu hover
    ...
    function makeTall() {
        $(this).children('.sub-menu').slideDown(300, 'easeInSine');
    }
...
(function ($, Drupal) {
    ...
    faqAction = function () {
        ...
        faqs = $('div.faq');
        faqTarget = $('.faq-list h4 a');

        // Hide all the faq details.
        faqs.hide();

        // Open faq details.
        faqTarget.click(function (event) {
            event.preventDefault();
            var faq = $(this).parent().next();
            // Close all.
            faqs.slideUp(500, 'easeInSine');
            // Open faq.
            faq.slideDown(500, 'easeInSine');
            // Apply class.
            faqTarget.removeClass('active');
            $(this).addClass('active');
        });
    };
